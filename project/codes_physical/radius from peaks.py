# Investigating changing planet radius impact on peak sizes
# 2 body motion in pixels
# 1 dark and 1 bright, of comparable size, lensed
...
for planetsize in range(1, 10):
    ...
    Planet = bodies.body_def(Mass=2e30, size=planetsize, x=maxR/2, y=0, vx=0, vy=-20000)  # Planet
